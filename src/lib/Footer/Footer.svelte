<div class="flex flex-col justify-center gap-6 sm:flex-row items-center">
    <div class="flex items-center">
        <div class="flex space-x-3 p-2">
            <button class="focus:outline-none" aria-label="previous">
            ...
            <button class="focus:outline-none" aria-label="play">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#4f46e5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
            </button>

            <button class="focus:outline-none" aria-label="next">
